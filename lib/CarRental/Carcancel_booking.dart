  ...
  Future<void> _submitCancellation(double finalRefund, double fee) async {
    ...
    if (_selectedReason == 'damage' && _proofImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "Photo proof is required for vehicle condition issues.",
          ),
          backgroundColor: Colors.red,
        ),
      );
                ...
                (c) => AlertDialog(
                  ...
                  content: const Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      Text(
                        "Your request has been submitted. An admin will review your photos and issue the appropriate refund shortly.",
                        textAlign: TextAlign.center,
                      ),
                    ],
                  ),
      ...
      // ========================================================
        ...
        for (var doc in carQuery.docs) {
          ...
          await FirebaseFirestore.instance
              .collection('rental_cars')
              .doc(doc.id)
              .update({'bookedDates': dbDates, 'status': 'available'});
        }
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: const [
                              DropdownMenuItem(
                                value: "plans",
                                child: Text("Change of plans"),
                              ),
                              DropdownMenuItem(
                                value: "price",
                                child: Text("Found a better price"),
                              ),
                              DropdownMenuItem(
                                value: "damage",
                                child: Text("Vehicle condition / Damage"),
                              ),
                              DropdownMenuItem(
                                value: "other",
                          ...
                          if (isDamageReport)
                            Padding(
                              ...
                              child: Text(
                                "Because you selected vehicle condition/damage, a photo is required for administrative review.",
                                style: TextStyle(
                          ...
                          CustomPaint(
                            painter: DashedRectPainter(
                              color:
                                  isDamageReport && _proofImage == null
                                      ? Colors.red.shade300
                                      : _borderDark,
                              strokeWidth: 2,
                              gap: 6,
                              ...
                              child: Column(
                                children: [
                                  _buildTimelineStep(
                                    ...
                                    subtitle:
                                        "Until ${DateFormat('MMM d, h:mm a').format(pickupTime.subtract(const Duration(hours: 24)))}",
                                    isLast: false,
                                    isFaded: cancellationFee > 0,
                                  ),
                                  _buildTimelineStep(
                                  ...
                                  _buildTimelineStep(
                                    ...
                                    subtitle:
                                        "After ${DateFormat('MMM d, h:mm a').format(pickupTime)}",
                                    isLast: true,
                                    isFaded: false,
                                  ),
                                ],
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    "Because you are reporting damage or vehicle condition issues, standard cancellation policies are paused. An admin will review your uploaded photos and determine the full refund amount.",
                                    style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                Text(
                  title,
                  style: TextStyle(
                    fontWeight: isFaded ? FontWeight.w600 : FontWeight.bold,
                    fontSize: 14,
                    color: _textColor,
                  ),
                ),
