  ...
  Future<void> _takePhoto(String slot) async {
    ...
    if (pickedFile != null) {
      setState(() {
        ...
        else if (slot == "Passenger Side")
          _passengerPhoto = File(pickedFile.path);
      });
    }
  }
  ...
  Future<void> _submitReturn() async {
    if (!_isLocationVerified) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "You must be at the drop-off location to return the vehicle.",
          ),
          backgroundColor: Colors.red,
        ),
      );
    ...
    if (_frontPhoto == null ||
        _backPhoto == null ||
        _driverPhoto == null ||
        _passengerPhoto == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Please take all 4 photos before returning."),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    try {
      ...
      if (carName.isNotEmpty) {
        ...
        for (var doc in carQuery.docs) {
          ...
          dbDates.removeWhere(
            (d) => datesToRemove.contains(d.toString()),
          ); // Erase the calendar blocks
        ...
        var carDoc =
            await FirebaseFirestore.instance
                ...
                .get();
        if (carDoc.exists) {
          List<dynamic> dbDates = List.from(
            carDoc.data()?['bookedDates'] ?? [],
          );
              ...
              (c) => AlertDialog(
                ...
                content: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text(
                      "Thank you! The vehicle inspection is complete and the car is now returned.",
                                ...
                                if (_targetLat != null && _targetLng != null)
                                  GoogleMap(
                                    initialCameraPosition: CameraPosition(
                                      target: LatLng(_targetLat!, _targetLng!),
                                      zoom: 15,
                                    ),
                                    markers: {
                                      Marker(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        _isVerifyingLocation
                                            ? "Checking GPS..."
                                            : (_isLocationVerified
                                                ? "You are in the designated drop-off zone."
                                                : "You are ${_distanceInMeters.toStringAsFixed(0)}m away from the drop-off zone."),
                                        style: TextStyle(
                                          fontSize: 13,
                                          color:
                                              isDark
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  "Please upload photos of the vehicle to document its condition and avoid any dispute fees.",
                                  style: TextStyle(
                                    fontSize: 14,
                                    color:
                                        isDark
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          "Make sure the license plate is visible in the Front and Back photos.",
                                          style: TextStyle(
                                            fontSize: 14,
                                            color:
                                                isDark
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              _isLocationVerified
                                  ? primaryColor
                                  : Colors.grey, // Grey out if not verified
                          foregroundColor: Colors.white,
                          elevation: 2,
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(12),
